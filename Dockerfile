...
COPY ["Koi-Web-BE/Koi-Web-BE.csproj", "Koi-Web-BE/"]

# Restore the dependencies
RUN dotnet restore "Koi-Web-BE/Koi-Web-BE.csproj"
...
WORKDIR /app/src/Koi-Web-BE
RUN dotnet publish Koi-Web-BE.csproj -c Release --no-restore -o /app/publish
...
ENTRYPOINT ["dotnet", "Koi-Web-BE.dll"]