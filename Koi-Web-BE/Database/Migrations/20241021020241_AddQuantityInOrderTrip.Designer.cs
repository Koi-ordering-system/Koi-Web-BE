...
namespace Koi_Web_BE.Database.Migrations
{
    ...
    [Migration("20241021020241_AddQuantityInOrderTrip")]
    partial class AddQuantityInOrderTrip
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Koi_Web_BE.Models.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Koi_Web_BE.Models.Entities.ChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Koi_Web_BE.Models.Entities.UserConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Koi_Web_BE.Models.Entities.ChatMessage", b =>
                {
                    b.HasOne("Koi_Web_BE.Models.Entities.ChatRoom", "ChatRoom")
                        .WithMany()
                        .HasForeignKey("ChatRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Koi_Web_BE.Models.Entities.User", "Sender")
                        .WithMany()
