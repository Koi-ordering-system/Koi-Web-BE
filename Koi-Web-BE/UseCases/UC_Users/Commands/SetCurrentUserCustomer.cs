...
public class SetCurrentUserCustomer
{
    public class Endpoint : IEndpoints
    {
        public static void DefineEndpoints(IEndpointRouteBuilder app)
        {
            app.MapPatch("api/users/customer", Handle)
                .WithMetadata(new SwaggerOperationAttribute("Update current user to customer"))
                .WithTags("Users")
    ...
    public class Handler(IApplicationDbContext context, CurrentUser currentUser) : IRequestHandler<Command, Result<Response>>
    {
        public async Task<Result<Response>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            int result = await context.Users
                ...
                .ExecuteUpdateAsync(e => e.SetProperty(u => u.Role, Models.Enums.RoleEnum.Customer), cancellationToken);
